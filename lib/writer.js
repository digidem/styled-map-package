...
export default class Writer extends EventEmitter {
   ...
   * @returns {string} source ID used in map package to reference this source
   */
  ...
  #prepareStyle() {
    ...
    metadata['smp:upstreamSourceIds'] = {}
    for (const [sourceId, { encodedSourceId }] of this.#sources) {
      metadata['smp:upstreamSourceIds'][encodedSourceId] = sourceId
    }
